...
E_AUTOMATICA, E_CONTROLADA = range(2)

SET_EST_OPE = [E_AUTOMATICA, E_CONTROLADA]

# estado de ativação da aeronave (newton)
E_ATIVA, E_CANCELADA, E_FINALIZADA, E_PENDENTE, E_QUEUED = range(5)

SET_EST_ATV = [E_ATIVA, E_CANCELADA, E_FINALIZADA, E_PENDENTE, E_QUEUED]

# função operacional (newton)
E_ALT, E_APROXIMACAO, E_APXPERDIDA, E_CANCELA, E_CDIR, E_CESQ, E_CMNR, E_DECOLAGEM, E_DES, \
    E_DIRFIXO, E_DIRPNTO, E_ESPERA, E_IAS, E_ILS, E_INTRADIAL, E_MACH, E_MANUAL, E_MOV, E_NIV, \
    E_NOPROC, E_ORBITA, E_POUSO, E_PROA, E_SSR, E_SUB, E_SUBIDA, E_TRAJETORIA, E_VEL, E_VISU = range(29)
...
SET_FNC_OPE = [E_ALT, E_APROXIMACAO, E_APXPERDIDA, E_CANCELA, E_CDIR, E_CESQ, E_CMNR, E_DECOLAGEM, 
               ...
               E_MOV, E_NIV, E_NOPROC, E_ORBITA, E_POUSO, E_PROA, E_SSR, E_SUB, E_SUBIDA, 
               E_TRAJETORIA, E_VEL, E_VISU]
...
DCT_FNC_OPE = {E_ALT:"ALT", E_APROXIMACAO:"APROXIMACAO", E_APXPERDIDA:"APXPERDIDA",
               ...
               E_NIV:"NIV", E_NOPROC:"NOPROC", E_ORBITA:"ORBITA", E_POUSO:"POUSO", E_PROA:"PROA", E_SSR:"SSR", 
...
E_FASE_2R, E_FASE_AFASTA, E_FASE_ALINHAR, E_FASE_APXALINHAR, E_FASE_ASSOCIADO, \
    ...
    E_FASE_TEMPOSETOR, E_FASE_VOLTA, E_FASE_ZERO = range(29)
