...
class CPaintEngine(object):
    ...
    def draw_aerodromo(self, fo_widget, f_aer):
        ...
        for l_pis in list(f_aer.dct_aer_pistas.values()):
    ...
    def draw_waypoint(self, fo_widget, f_obj, fv_nameless):
        ...
        if isinstance(f_obj, str):
            self._draw_waypoint_name(fo_widget, f_obj, fv_nameless)

        elif isinstance(f_obj, cfix.CFix):
            self._draw_waypoint_fix(fo_widget, f_obj, fv_nameless)

    # ---------------------------------------------------------------------------------------------
    def _draw_waypoint_name(self, fo_widget, f_name, fv_nameless):
        """
        DOCUMENT ME!
        """
        ...
        self._draw_waypoint_fix(fo_widget, l_fix, fv_nameless)

        del l_fix

    # ---------------------------------------------------------------------------------------------
    def _draw_waypoint_fix(self, fo_widget, f_fix, fv_nameless):
        """
        DOCUMENT ME!
        """
        # check input
