...
class CColorManager(object):
    ...
    c_color_id = wnd_default_bkgrnd, wnd_default_frgrnd, wnd_default_highlight, \
                 ...
                 sel_menu_default_frgrnd, grayed_out = range(12)
    ...
    def __init__(self, fo_config=None, fs_path=None):
        ...
        # (int)
        self._lst_category = [100 for _ in range(len(self.c_lst_category))]

        # (int)
        self._i_master_category = 100
    ...
    def get_brightness(self, fi_category):
        ...
        if M_MasterCategory == fi_category:
            # return
            return self._i_master_category

        # return
        return self._lst_category[fi_category]
    ...
    def set_brightness(self, fi_category, fi_value):
        ...
        if M_MasterCategory == fi_category:
            ...
            self._i_master_category = fi_value

        # otherwise,...
        else:
            # save category brightness
            self._lst_category[fi_category] = fi_value
    ...
    def transform_color(self, ft_color, fi_category):
        ...
        # otherwise,...
            ...
            li_offset = self._lst_category[fi_category]
